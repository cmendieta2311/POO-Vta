 ...
 * @author Cris_
 */
public class Persona extends javax.swing.JDialog {

    /**
     * Creates new form Persona
     */
    public Persona(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Persona dialog = new Persona(new javax.swing.JFrame(), true);
